...
class AlienInvasion:
    ...
    def _update_aliens(self):
        """
        Check if the positions is at an edge and updates the position
        of every alien in the fleet
        """
    ...
    def _create_fleet(self):
        ...
        number_rows = available_space_y // (2 * alien_height) - 4
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as a hit to the ship.
                self._ship_hit()
                break
